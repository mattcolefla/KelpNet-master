...
namespace KelpNet.Common.Functions
{
    ...
    [Serializable]
    public abstract class CompressibleActivationLayer : SingleInputLayer, IParallelizable
    {
        /// <summary>   Name of the function. </summary>
        const string FUNCTION_NAME = "ActivationLayer";
        ...
        protected CompressibleActivationLayer([NotNull] string functionName, [CanBeNull] KeyValuePair<string, string>[] parameters, [CanBeNull] string name = FUNCTION_NAME, [CanBeNull] string[] inputNames = null, [CanBeNull] string[] outputNames = null, bool gpuEnable = false) : base(name, inputNames, outputNames)
        {
