...
namespace KelpNet.Common.Functions.Type
{
    ...
    ///
    /// <seealso cref="T:KelpNet.Common.Functions.NetworkLayer"/>
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    [Serializable]
    public abstract class SingleInputLayer : NetworkLayer
    {
        ...
        protected SingleInputLayer([CanBeNull] string name, [CanBeNull] string[] inputNames = null, [CanBeNull] string[] outputNames = null) : base(name, inputNames, outputNames)
        {
        }
        ...
        {
            return new[] { Predict(verbose, xs[0]) };
        }
        ...
        [CanBeNull]
        public virtual NdArray Predict(bool verbose, [CanBeNull] NdArray input)
        {
