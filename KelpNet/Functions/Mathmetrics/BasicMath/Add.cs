...
namespace KelpNet.Functions.Mathmetrics.BasicMath
{
    ...
    public class Add : DualInputFunction
    {
        ...
        public Add([CanBeNull] string name = FUNCTION_NAME, [CanBeNull] string[] inputNames = null, [CanBeNull] string[] outputNames = null) : base(name, inputNames, outputNames)
        {
    ...
    public class AddConst : DualInputFunction
    {
        ...
        public AddConst([CanBeNull] string name = FUNCTION_NAME) : base(name)
        {
            DualInputForward = ForwardCpu;
            DualOutputBackward = BackwardCpu;
        }
