...
namespace KelpNet.Functions.Activations
{
    ...
    public class LeakyReLUShifted : CompressibleActivation
    {
        ...
        public LeakyReLUShifted(string name = FUNCTION_NAME, string[] inputNames = null, string[] outputNames = null, bool gpuEnable = false) : base(FUNCTION_NAME, null, name, inputNames, outputNames, gpuEnable)
        {
        }
